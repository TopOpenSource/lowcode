...
import {myFinishedTask} from "@/api/lowcode/task/task";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      myFinishedTask(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    handleProcess(row) {
     this.$router.push({ path: '/lowcode/audit',query: { objectId: row.objectId,
                                                                      ...
                                                                      actId:row.actId,
                                                                      taskId:row.taskId,
                                                                      from:{ url:'/lowcode/finished_task',query:{}}
                                                               } });
    },
