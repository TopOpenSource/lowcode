...
export const saveFormObjectAttributeMX = params => {
  return request({
    url: '/lowcode/form/sysFormObjectAttribute/saveFormObjectAttributeMX',
    method: 'post',
    data: params
  })
...
export const deleteAttr = params => {
  return request({
    url: '/lowcode/form/sysFormObjectAttribute/deleteAttr',
    method: 'post',
    data: params
  })
};
